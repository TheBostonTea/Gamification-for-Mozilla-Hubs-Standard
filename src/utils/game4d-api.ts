...
function G4DUNKNOWNACTION(eid: number, mem: G4DInnerMemory, ...args: Array<G4DVar>) {
...
function G4DConsolelog(eid: number, mem: G4DInnerMemory, strf: G4DVar, ...args: Array<G4DVar>) {
...
function G4DIncrement(eid: number, mem: G4DInnerMemory, a: G4DVar) {
...
function G4DReturn(eid: number, mem: G4DInnerMemory, ...args: Array<G4DVar>) {
